...
import Backend.Restaurante.projection.FaturamentoDiarioProjection;
import Backend.Restaurante.projection.PedidosPorStatusProjection;
import Backend.Restaurante.projection.ProdutoMaisVendidoProjection;
import Backend.Restaurante.projection.TicketMedioProjection;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;

import java.util.List;

public interface RelatorioRestauranteRepository extends JpaRepository<Pagamento, Long> {
